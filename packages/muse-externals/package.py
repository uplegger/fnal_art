...
class MuseExternals(BundlePackage):
    ...
    def setup_run_environment(self, env):
        ...
        deplist=[ 
            "artdaq-core-mu2e", "artdaq-core", "art-root-io", "art",
            "boost", "btrk", "canvas", "cetlib-except", "cetlib", "clhep",
            "cryptopp", "fhiclcpp", "gsl", "hep-concurrency", "kinkal",
            "messagefacility", "mu2e-pcie-utils", "openblas", "postgresql",
            "python", "root", "sqlite", "tbb", "trace", "vecgeom", "xerces-c",
        ]
        ldl = []
        for dep in deplist:
